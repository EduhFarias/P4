...
public class FrameAcceptProduct extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrameAcceptProduct
     */
    public FrameAcceptProduct() {
        initComponents();
        Data data = new Data();
        data = data.getData();
        ...
        for(Product current : data.getProducts()){
            if(!current.isAccepted()){
                Object[] objects = {current.getName(), current.getAuthor(), current.getType(), current.getSender().getName(), current.isAccepted()};
    ...
    private void initComponents() {
        ...
        jMIAceitar = new javax.swing.JMenuItem();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Aceitar conteúdos");
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Título", "Autor", "Tipo", "Cadastrado por", "Selecionar"
            }
        ) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jBReject, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jMIAceitar.setText("Aceitar");
        jMIAceitar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMIAceitarActionPerformed(evt);
            }
        });
        jMenu1.add(jMIAceitar);
    ...
    private void jBAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAcceptActionPerformed
        ...
        for(int i = 0; i < jTable.getRowCount(); i++){
            ...
            if(choice){
                ...
                admin.AcceptProduct(title);
            }
        }
        JOptionPane.showMessageDialog(this, "Contéudos adicionados ao banco!");
        FrameAcceptProduct frame = new FrameAcceptProduct();
        this.dispose();
        frame.setVisible(true);
    }//GEN-LAST:event_jBAcceptActionPerformed

    private void jMIAceitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMIAceitarActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(this, "Selecione os itens que deseja adicionar ao banco de conteúdos", "Aceitar", 1, null);
    }//GEN-LAST:event_jMIAceitarActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameAcceptProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameAcceptProduct().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenuItem jMIAceitar;
